                    ...
                    <div className="overflow-hidden">
                        ...
                        >
                            {testimonials.map((t, i) => (
                                ...
                                >
                                    <div className="bg-white rounded-2xl p-4 md:p-6 lg:p-8 border border-gray-100 shadow-sm h-full flex flex-col justify-between">
                                        <div>
                                            <div className="flex items-center gap-3 md:gap-4 mb-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="font-semibold text-sm md:text-base lg:text-lg truncate">{t.name}</p>
                                                    <p className="text-xs md:text-sm text-[#666B6E] truncate">{t.role}</p>
                                                </div>
                                            </div>
                                            <span className="text-yellow-400 text-sm md:text-base mb-3 block shrink-0">{t.rating}</span>
                                            <p className="text-xs md:text-sm lg:text-base text-[#444] leading-relaxed italic line-clamp-4">
                                                {t.content}
                                            </p>
                                        </div>
                                    </div>
